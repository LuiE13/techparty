...
function tmncbixin() {
   ...
   clearInterval(id)
    ...
    function andarobj() {
        if ((pos1>=600 || pos1<-45.5) && posf%2!=0.5 && posf%2!=1.5 && (pos2>=600  || pos2<-45.5 )&& (pos3>=600  || pos3<-45.5) && (pos4>=600  || pos4<-45.5)) {
            posf+=1
        } else  {
            posf+=0.5
        }
        ...
        if(pos1<-45.5 &&pos2<-45.5&&pos3<-45.5&&pos4<-45.5){
